...
input_images = get_input_files_list("./testset/s2")
...
for i in range(len(input_images)):
    ...
    # Assuming only one bounding box is detected
    box_bounding_box = box_bounding_list[0]
...
for i in set(input_images):
    ...
    if i in set(invalid_images):
        results = adjust_image_dummy_values(0,
                                            0,
                                            0,
                                            i,
                                            [plots[0]],
